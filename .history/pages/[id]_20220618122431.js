    ...
    <main className="bg-black min-h-screen flex max-w-[1500px] mx-auto" >
      ...
      <div className="flex-grow border-l
       ...
       xl:ml-[370px]">
        ...
        border-gray-700 text-[#d9d9d9] font-semibold text-xl gap-x-4 sticky z-50 bg-black">
            <div className="hoverAnimation w-9 h-9 flex items-center" onClick={router.push('/')}>
