  ...
  return (
    ...
    <div className='flex items-center justify-between pt-2.5'>
        <div className='flex items-center'>
          ...
          <div className='icon relative' onClick={openDatepicker}>
            <CalendarIcon className='h-[22px] text-[#1d9bf0]' />
            {
              open && <Calender className="bg-white absolute text-black p-2 max-w-lg w-screen focus-within:bg-blue-500" onChange={setDate} value={date} ref={datePickerRef}/>
            }
          </div>
        </div>
        </div>
